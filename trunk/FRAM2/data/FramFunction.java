 ...
 *
 */
public class FramFunction implements java.io.Serializable {
	/**
	 * 
	 */
	...
	public FramFunction(String name){
		init();
	...
	public Point getPortLocation(FramFunction.NodePort connPoint) {
		Point p = null;
		Polygon poly = getPolygon();
		
		for(int i = 0; i < FramFunction.NodePort.values().length; i++) {
			if(connPoint == FramFunction.NodePort.values()[i]) {
				p = new Point(
						poly.xpoints[i],
						poly.ypoints[i]);
	...
	public Rectangle getPortRectangle(FramFunction.NodePort connPoint) {
	...
	public Polygon getPolygon() {
		return FramFunction.getPolygon(getRectangle());
	}
	...
	public ArrayList<FramFunction> getConnectedNodes() {
		ArrayList<FramFunction> connectedList = new ArrayList<FramFunction>();
	...
	public String[] getAllEntities() {
		...
		for(FramFunction.NodePort conn : FramFunction.NodePort.values()) {
...
//		}
	...
	public boolean equals(FramFunction node) {
		if(node == null) {
			return false;
		}
	...
	public String[] getCPCtext(FramFunction.NodePort port) {
